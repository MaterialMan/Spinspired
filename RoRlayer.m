classdef RoRlayer < nnet.layer.Layer & nnet.layer.Formattable
...
%         internal_weights
    ...
    methods
        function layer = RoRlayer(numHiddenUnits,inputSize,args)
            ...
            layer.Description = "RoR with " + numHiddenUnits + " channels";
...
% 
%             % input weights
%             layer.input_weights = full(population.input_weights'); 
% 
%             % internal weights
%             layer.internal_weights = full(population.W);
        ...
        function [Z,HiddenState] = predict(layer,X)
            ...
            %layer.population.input_weights = layer.input_weights';
