#!/bin/bash
#SBATCH --job-name=STOdiabetes       # Job name
...
matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{36},"diabetes",10,1000,0)'
matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{64},"diabetes",10,1000,0)'

matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{36},"diabetes",10,1000,1)'
matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{64},"diabetes",10,1000,1)'
