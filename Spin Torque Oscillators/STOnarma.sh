#!/bin/bash
#SBATCH --job-name=STOnarma       # Job name
...
matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{36},"narma_10",10,1000,0)'
matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{64},"narma_10",10,1000,0)'

#matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{36},"narma_10",10,1000,1)'
#matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{64},"narma_10",10,1000,1)'
