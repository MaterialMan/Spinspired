#!/bin/bash
#SBATCH --job-name=STOvowels       # Job name
...
matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{36},"japanese_vowels",10,1000,0)'
matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{64},"japanese_vowels",10,1000,0)'

#matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{36},"japanese_vowels",10,1000,1)'
#matlab -r 'MicrobialGAFcn($SLURM_ARRAY_TASK_ID,"STO",{64},"japanese_vowels",10,1000,1)'
