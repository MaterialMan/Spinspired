function[final_states,individual] = collectRestrictedRoRStates(individual,input_sequence,config,target_output)
...
input = ([input_sequence repmat(individual.bias_node,size(input_sequence,1),1)]*((individual.input_weights.*individual.restricted_input_mask).*individual.input_scaling));
...
% restrict states
final_states(:,~logical(individual.restricted_output_mask)) = 0;
