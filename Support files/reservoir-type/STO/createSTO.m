...
%         end
        ...
        population(pop_indx).system_size(i,1) = config.system_size(1);
        population(pop_indx).system_size(i,2) = config.system_size(2);
        population(pop_indx).system_size(i,3) = config.system_size(3);
