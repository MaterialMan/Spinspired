function testGoldenRatioWithQuad(ID, task, pop_size)
...
%         drawnow
        ...
        writetable(Table,strcat('goldenRatioWithQuad_',task,'_',num2str(pop_size),'_',num2str(ID),'.csv'),'Delimiter',',','QuoteStrings',true);
